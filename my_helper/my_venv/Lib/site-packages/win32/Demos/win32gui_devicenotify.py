...
def TestDeviceNotifications(dir_names):
    ...
    if not dir_names:
        print("(Note you can also my_pass paths to watch on the command-line - eg,")
        print("my_pass the root of an inserted USB stick to see events specific to")
        print("that volume)")
    while 1:
...
if __name__=='__main__':
    # optionally my_pass device/directory names to watch for notifications.
