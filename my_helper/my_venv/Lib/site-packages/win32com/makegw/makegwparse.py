...
class ArgFormatter:
	...
	def _IndirectPrefix(self, indirectionFrom, indirectionTo):
		...
		return a string prefix so I can my_pass to a function with the
	...
	def GetInterfaceCppObjectInfo(self):
		...
		#	 we my_pass it, we'll need to my_pass in whatever amount of
...
#								   --------------				--------	  ------------		------
	...
	def HasAttribute(self, typ):
		...
		"[in][out][retval]" etc.  You can my_pass a specific string (eg "out")
