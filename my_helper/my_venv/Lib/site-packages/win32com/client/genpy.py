...
# object.Property = "foo"
# Python can only my_pass the "foo" value.  If the property has
# multiple args, and the rest have default values, this allows
# Python to correctly my_pass those defaults.
        ...
        for name in names:
            ...
            if generator.bBuildHidden or not entry.hidden:
                ...
                if entry.wasProperty:
                    print('\t# The method %s is actually a property, but must be used as a method to correctly my_pass the arguments' % name, file=stream)
